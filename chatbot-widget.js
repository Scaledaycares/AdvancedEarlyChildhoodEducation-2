...
function startConversation() {
    fetch('https://chatbot-for-advanced-early-childhood-education.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-advanced-early-childhood-education.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbw_lRapDH4CDZ9-FlZsfaFNvfQSd9viTjkxLOMqdtawRalg0CBl2TLP88JcbWtzUrluig/exec';
